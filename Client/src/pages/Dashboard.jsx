...
const Dashboard = () => {
  ...
  // compute KPIs using useMemo to avoid unnecessary recalculations
  const kpis = useMemo(() => {
  ...
  // compute recent invoices (sorted by creation date) using useMemo
  ...
  //to fetch client name for display
    ...
    <div className={dashboardStyles.pageContainer}>
      <div className={dashboardStyles.headerContainer}>
        ...
        <p className={dashboardStyles.headerSubtitle}>
          Track your invoice performance and recent activity at a glance
        </p>
      </div>
      {/* ---------- LOADING ERROR STATE ---------- */}
      {loading ? (
          ...
          <div className={dashboardStyles.cardContainerOverflow}>
            <div className={dashboardStyles.tableHeader}>
              <div className={dashboardStyles.tableHeaderContent}>
                ...
                <button className={dashboardStyles.tableActionButton}>
                  View All
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 24 24"
