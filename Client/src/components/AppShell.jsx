        ...
        >
          ...
          <div className={appShellStyles.sidebarContainer}>
            ...
            <div className={appShellStyles.userSection}>
              ...
              <button 
                onClick={logout} 
                className={`w-full flex items-center ${collapsed ? 'justify-center' : 'gap-3'} px-3 py-3 rounded-xl text-sm font-medium text-red-600 hover:bg-red-50 hover:shadow-sm transition-all duration-300 group`}
              >
